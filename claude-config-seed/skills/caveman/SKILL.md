...
Vendored verbatim (MIT-licensed) from https://github.com/JuliusBrussee/caveman,
`skills/caveman/SKILL.md`, `main` branch, retrieved 2026-08-18. Root repo license is MIT;
only the Engine-linked directories (`engine/`, `proxy/`, `mcp/`, etc. — not included here)
are BSL-1.1. This is the plain-skill install only — no proxy, CLI, or MCP components.
