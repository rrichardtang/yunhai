...
Vendored verbatim (MIT-licensed) from https://github.com/mattpocock/skills,
`skills/engineering/wayfinder/SKILL.md`, `main` branch @ `885e2ca`, retrieved 2026-08-19.
Calls into the `grilling`, `domain-modeling`, `research`, and `prototype` skills vendored
alongside it — all four are required for this skill to function.
