...
3. **AI calls**: A global semaphore caps Anthropic calls at 10 concurrent across all users. Cities are planned 3 in parallel. Claude Sonnet 4.6 handles activity planning; GPT-5.4-mini handles chat concierge and activity refinement; Haiku handles fast profile summaries.
